<template>
  <div class="card">
    <div class="card-body">
      <h5 class="fw-500 text-uppercase">Return By Payment</h5>
      ...
      <div class="d-flex align-items-end justify-content-between">
        <div class="d-flex align-items-end">
          ...
          <button
            ...
            @click="$store.dispatch('laporanReturn/showLaporanReturnByPayment')"
          >
        ...
        <table class="table table-hover table-striped table-bordered">
          <thead>
            <tr class="text-center">
              ...
              <th style="width: 40%">Tender Name</th>
...
export default {
  name: "LaporanReturnByPaymentView",
  data() {
    return {
      show: false,
    };
  ...
  methods: {
    ...
    exportCsv() {
      Export.exportCsv(this.datas, "Laporan_Return_By_Payment.csv");
    },
    exportExcel() {
